...
int BILWriter::WriteBandLineSection(char* const data,const unsigned int numsamples_array,const unsigned int start, const unsigned int end)
{
...
void BILWriter::AddMetadata(std::string name,std::string value)
{
   hdrtext<<name<<" = "<<value<<std::endl;
}
